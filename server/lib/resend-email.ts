...
export async function sendWithdrawalRequestNotification(data: WithdrawalRequestData): Promise<boolean> {
  ...
  try {
    ...
    const { data: emailData, error } = await resend.emails.send({
      ...
      subject: '💰 New Withdrawal Request - Cursai Admin',
      html: `
        <!DOCTYPE html>
        <html>
          <head>
          ...
          <body>
            <div class="container">
              ...
              <div class="footer">
                <p>Cursai - AI-Powered Crypto Predictions</p>
              </div>
            </div>
          </body>
        </html>
...
export async function sendUnlimitedAccessClickedNotification(data: UnlimitedAccessClickedData): Promise<boolean> {
  ...
  try {
    ...
    const { data: emailData, error } = await resend.emails.send({
      from: fromEmail,
      to: notificationEmail,
      subject: '🎯 New User Interested in Upgrading - Cursai',
      html: `
        <!DOCTYPE html>
        <html>
          <head>
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                <p>A user just expressed interest in upgrading to a premium plan on Cursai!</p>
                ...
                <p style="color: #6b7280; font-size: 14px; margin-top: 20px;">
                  This notification is sent automatically when users click the upgrade options in your Cursai app.
                </p>
              </div>
