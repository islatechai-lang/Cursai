        ...
        <div className="min-h-screen w-full bg-background text-foreground p-6 md:p-12 overflow-y-auto">
            <div className="max-w-3xl mx-auto space-y-8 pb-12">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        Your data is used solely to provide the services of Cursai. This includes managing your analysis history, calculating credits, and improving the accuracy of our AI models.
                    </p>
                </section>
