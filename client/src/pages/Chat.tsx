...
import { type Message, type TradingPair, type AnalysisStage, type Timeframe, type ChatSessionWithMessages, type UserCredits } from "@shared/schema";
  ...
  return (
    <div className="flex flex-col h-screen bg-background" data-testid="chat-page">
      ...
      <PricingModal
        ...
        companyId={credits?.userId}
        currentPlan={credits?.subscriptionPlan}
      />
    </div>
  );
}
